...
default_cfgs = {
    ...
    'efficientnet_b0': _cfg(
        url='../backbone/efficientnet_b0_ra-3dd342df.pth'
        #url='../backbone/tf_efficientnet_b0_ns-c0e6a31c.pth'
        ),
    'efficientnet_b1': _cfg(
        url='../backbone/efficientnet_b1-533bc792.pth',
        input_size=(3, 240, 240), pool_size=(8, 8)),
    'efficientnet_b2': _cfg(
        url='../backbone/efficientnet_b2_ra-bcdf34b7.pth',
        input_size=(3, 260, 260), pool_size=(9, 9)),
    'efficientnet_b2a': _cfg(
        url='../backbone/efficientnet_b2_ra-bcdf34b7.pth',
        input_size=(3, 288, 288), pool_size=(9, 9), crop_pct=1.0),
    'efficientnet_b3': _cfg(
        url='../backbone/efficientnet_b3_ra2-cf984f9c.pth',
        input_size=(3, 300, 300), pool_size=(10, 10), crop_pct=0.904),
    'efficientnet_b3a': _cfg(
        url='../backbone/efficientnet_b3_ra2-cf984f9c.pth',
        input_size=(3, 320, 320), pool_size=(10, 10), crop_pct=1.0),
    'efficientnet_b4': _cfg(
        url='../backbone/tf_efficientnet_b4_ns-d6313a46.pth', 
        input_size=(3, 380, 380), pool_size=(12, 12), crop_pct=0.922),
    'efficientnet_b5': _cfg(
        url='../backbone/tf_efficientnet_b5_ns-6f26d0cf.pth', input_size=(3, 456, 456), pool_size=(15, 15), crop_pct=0.934),
    'efficientnet_b6': _cfg(
        url='../backbone/tf_efficientnet_b6_ns-51548356.pth', input_size=(3, 528, 528), pool_size=(17, 17), crop_pct=0.942),
    ...
    'tf_efficientnet_b4': _cfg(
        #url='../backbone/tf_efficientnet_b4_aa-818f208c.pth',
        url='../backbone/tf_efficientnet_b4_ns-d6313a46.pth',
        input_size=(3, 380, 380), pool_size=(12, 12), crop_pct=0.922),
    'tf_efficientnet_b5': _cfg(
        #url='../backbone/tf_efficientnet_b5_ra-9a3e5369.pth',
        url='../backbone/tf_efficientnet_b5_ns-6f26d0cf.pth',
        input_size=(3, 456, 456), pool_size=(15, 15), crop_pct=0.934),
    'tf_efficientnet_b6': _cfg(
        url='../backbone/tf_efficientnet_b6_aa-80ba17e4.pth',
        input_size=(3, 528, 528), pool_size=(17, 17), crop_pct=0.942),
    'tf_efficientnet_b7': _cfg(
        url='../backbone/tf_efficientnet_b7_ra-6c08e654.pth',
        input_size=(3, 600, 600), pool_size=(19, 19), crop_pct=0.949),
    'tf_efficientnet_b8': _cfg(
        url='../backbone/tf_efficientnet_b8_ra-572d5dd9.pth',
        input_size=(3, 672, 672), pool_size=(21, 21), crop_pct=0.954),

    'tf_efficientnet_b0_ap': _cfg(
        url='../backbone/tf_efficientnet_b0_ap-f262efe1.pth',
