...
#                     tta.HorizontalFlip(),
#                     tta.VerticalFlip(),
#                     tta.Rotate90(angles=[0, 270]),
#                     tta.Scale(scales=[1, 2]),
#                     tta.Multiply(factors=[0.9, 1, 1.1]),
#                     tta.FiveCrops(507, 507),
#                     tta.Resize([(512,512)]) # List[Tuple[int, int]]  Tuple[int,int]  "nearest"/"linear"
                ]
            )
            # merge_mode 1.mean 2.gmean (geometric mean) 3.sum 4.max 5.min 6.tsharpen (temperature sharpen with t=0.5)
