...
default_cfgs = dict(
    ...
    regnetx_064=_cfg(url='../backbone/regnetx_064-29278baa.pth'),
    ...
    regnety_032=_cfg(url='../backbone/regnety_032_ra-7f2439f9.pth'),
    regnety_040=_cfg(url='../backbone/regnety_040-f0d569f9.pth'),
    regnety_064=_cfg(url='../backbone/regnety_064-0a48325c.pth'),
    regnety_080=_cfg(url='../backbone/regnety_080-e7f3eb93.pth'),
    regnety_120=_cfg(url='../backbone/regnety_120-721ba79a.pth'),
    regnety_160=_cfg(url='../backbone/regnety_160-d64013cd.pth'),
